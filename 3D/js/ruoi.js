	...
	// }else{
		...
		setTimeout(function() {
			//if (Math.random() < show_percent/100) {
				...
				switch (value) { 
					case 1: 
						var fly = new Fly("test", "Nhặng", "Xanh", height_fly, width_fly, 0, 0, "js/images/ruoi_11.png", "Tiểu Long Ruồi", "Cổ Mộ");
						break;
					case 2:
					 	var fly = new Fly("test", "Ruồi", "Đen", height_fly, width_fly, 0, 0, "js/images/ly_mac_ruoi.png", "Lý Mạc Ruồi", "Cổ Mộ");						
					 	break;
					case 3: 
					 	var fly = new Fly("test", "Ruồi", "Đỏ", height_fly, width_fly, 0, 0, "js/images/doc_co_ruoi.png", "Độc Cô Ruồi", "Tiêu Dao");		
					 	break;
					case 4: 
						var fly = new Fly("test", "Nhặng", "Nâu", height_fly, width_fly, 0, 0, "js/images/ruoi_9.png", "Nhạc Bất Ruồi", "Hoa Sơn");		
						break;
			...
			if(var_2){
				if (Math.random() < show_percent_fly2/100) {
					...
					var fly2 = new Fly("test", "Nhặng", "Đen", height_fly, width_fly, 0, 0, "js/images/ly_mac_ruoi.png", "Lý Mạc Ruồi", "Cổ Mộ");	
					fly2.move();
					fly2.flying();
